    ...
    <div id="wrap">
        ...
        <div id="fillter">
            ...
            <div id="money">
                ...
                <input type="range" min="0" max="100000" step="500" class="slider">
                <p class="result"></p>
            </div>
            <div id="type">
                <button type="button" class="moreBtn1"><i id="fa1" class="fas fa-arrow-circle-down"></i> 시설 타입</button>
                <div id="moreType" class="hide">
                    <label class="type1"><input type="checkbox">자연/공원</label>
                    <label class="type1"><input type="checkbox">랜드마크(놀이공원)</label>
                    <label class="type1"><input type="checkbox">박물관/동물원/아쿠아리움</label>
                    <label class="type1"><input type="checkbox">문화재/유적지</label>
                    <label class="type1"><input type="checkbox">수상 스포츠</label>
                    <label class="type1"><input type="checkbox">일반 스포츠</label>
                    <label class="type1"><input type="checkbox">오락</label>
                    <label class="type1"><input type="checkbox">기타</label>
                </div>
            </div>
            <div id="install">
                <button type="button" class="moreBtn2"><i id="fa2" class="fas fa-arrow-circle-down"></i> 시설 특징</button>
                <div id="moreInstall" class="hide">
                    ...
                    <label class="type1"><input type="checkbox" name="install">화장실</label>
                    <label class="type1"><input type="checkbox" name="install">무료 와이파이</label>
                    <label class="type1"><input type="checkbox" name="install">카페테리아</label>
                    <label class="type1"><input type="checkbox" name="install">장애인 시설 완비</label>
                    <label class="type1"><input type="checkbox" name="install">실내공간</label>
                    <label class="type1"><input type="checkbox" name="install">셔틀버스</label>
                </div>
            </div>
            <div id="userReview">
        ...
        <div id="select">
            ...
            <button id="cultureBtn" type="button" class="categoryBtn on">관광지</button>
        </div>
        <div id="content">
            <div class="element">
                <div class="ele_picture">
                    <img src="/img/culture.jpg" alt="관광">
                </div>
                <div class="ele_info">
                    <h2 class="location_name">경복궁</h2>
                    <h2 class="fonderImg"><i class="fas fa-user-circle"></i>서울킬러</h2>
                    <h3 class="location_intro">과거와 현재, 그 사이를 걷다</h3>
                    <span class="s_price1">성인 기준 입장료 </span>
                    <span class="s_price2">7,000 원</span><br/>
                    <span class="location_address">서울특별시 종로구</span>
                    <span class="score"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></span>
                    <i class="far fa-heart"> 20,031</i>
                </div>
            </div>
            <div class="element">
                <div class="ele_picture">
